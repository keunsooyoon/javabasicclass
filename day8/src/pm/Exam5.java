...
/*
 ...
 잘못된 다운캐스팅을 수행하면 ClassCastException 이 발생하고 프로그램이 종료된다. 
  ...
  첫번쨰 human1객체는 사람 클래스로 만들었기 때문에 여기에는 사람의 공통된 속성과 기능들만
  포함되어 있다.그렇게 때문에 학생으로의 다운캐스팅은 불가능하다. 
